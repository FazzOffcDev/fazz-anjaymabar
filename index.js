...
// Configuration
const apikey = 'ptla_0gaquUvq1iCBdrdm4gGYphGLlOsJQPom2aCwdGQb1gA';
const capikey = 'ptlc_CTy0V5jOOKGfvHNcL0Qd8yrDmaPdL6zc9lJi4T6FNr3';
const domain = 'https://langxzz.storedigital.web.id';
const nestid = '5';
const egg = '15';
const loc = '1';
const gmailadmin = 'fazzcodex@gmail.com'; // Admin email that won't be deleted
const telegramBotToken = '8350291703:AAG6EN5Nm2a9sHEIUdsxAznctvwbnT0EWq0';
const adminTelegramId = '8243394905';
